...
// in nomoca_flutter/test/presentation/favorite_list_view_next_reserve_date_dialog_test.dart.
...
/// A class which mocks [UpdateNextReserveDateRepository].
///
/// See the documentation for Mockito's code generation for more information.
class MockUpdateNextReserveDateRepository extends _i1.Mock
    implements _i3.UpdateNextReserveDateRepository {
  MockUpdateNextReserveDateRepository() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<void> updateNextReserveDate(
          {int? userId, int? institutionId, String? reserveDate}) =>
      (super.noSuchMethod(
          Invocation.method(#updateNextReserveDate, [], {
            #userId: userId,
